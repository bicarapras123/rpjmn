        ...
        <div class="max-w-4xl mx-auto sm:px-4 px-2">
            ...
            <div class="bg-white shadow-md rounded-xl p-6">
                ...
                @if(Auth::user()->role === 'admin')
                    <form action="{{ route('laporan.kirim') }}" method="POST" class="space-y-4">
                        @csrf
                            ...
                            <tbody>
                                @foreach($laporans as $laporan)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-4 py-2 border">{{ $laporan->nama }}</td>
                                        <td class="px-4 py-2 border">{{ $laporan->unit }}</td>
                                        <td class="px-4 py-2 border">{{ $laporan->email }}</td>
                                        <td class="px-4 py-2 border whitespace-pre-line">{{ $laporan->isi }}</td>
